...
const addUserAddress = () => {
  ...
  axios
      .post('DeliveryAddressController/saveDeliveryAddress', deliveryAddress.value)
      .then(response => {
        if (response.data > 0) {
          router.push({ path: '/userAddress', query: { businessId } });
        } else {
          alert('新增地址失败！');
        }
      })
		...
		<ul class="form-box">
			...
			<li>
				...
				<div class="content" style="font-size: 3vw;">
					<input type="radio" v-model="deliveryAddress.contactSex" value="1" name="gender" style="width:6vw;height:3.2vw;">男
					<input type="radio" v-model="deliveryAddress.contactSex" value="0" name="gender" style="width:6vw;height:3.2vw;">女
				</div>
			</li>
			<li>
				<div class="title">
